...
{
    IRuleChainBuilder<TEntity, TProperty> Create<TEntity, TProperty>(IValidationBuilder<TEntity> validationBuilder);
}

internal sealed class RuleChainBuilderFactory : IRuleChainBuilderFactory
{
    public IRuleChainBuilder<TEntity, TProperty> Create<TEntity, TProperty>(
